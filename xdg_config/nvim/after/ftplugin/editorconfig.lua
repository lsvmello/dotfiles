if _G._editorconfig_omnifunc == nil then
  local completion_table_map = {
    root = {
      compl_item = { word = 'root =', abbr = 'root', menu = '[property]', info = 'Defines the top-most EditorConfig file' },
      values =  {
    ...
    tab_width = {
      compl_item = { word = 'tab_width =', abbr = 'tab_width', menu = '[property]', info = 'Width of a single tabstop character' },
      values = {}
    },
    end_of_line = {
      compl_item = { word = 'end_of_line =', abbr = 'end_of_line', menu = '[property]', info = 'Line ending file format' },
      values = {
        { word = 'lf', menu = '[value]' },
    ...
    trim_trailing_whitespace = {
      compl_item = { word = 'trim_trailing_whitespace =', abbr = 'trim_trailing_whitespace', menu = '[property]', info = 'Denotes whether whitespace is removed from the end of lines' },
      values = {
        { word = 'true', menu = '[value]' },
        { word = 'false', menu = '[value]' },
      }
    ...
    insert_final_newline = {
      compl_item = { word = 'insert_final_newline =', abbr = 'insert_final_newline', menu = '[property]', info = 'Denotes whether file should end with a newline' },
      values = {
        { word = 'true', menu = '[value]' },
        { word = 'false', menu = '[value]' },
      }
    ...
    max_line_length = {
      compl_item = { word = 'max_line_length =', abbr = 'max_line_length', menu = '[property]', info = 'Forces hard line wrapping after the amout of characters specified' },
      values = {
        { word = 'unset', menu = '[value]' },
      }
    },
    spelling_language = {
      compl_item = { word = 'spelling_language =', menu = '[property]', info = 'A code of the format ss or ss-TT, where ss is an ISO 639 language code and TT is an ISO 3166 territory identifier'},
      values = { }
    },
  }
